...
function Accessories() {
  ...
  const Products = [
    ...
    },
    {
      ...
      alt: "RWDY WINTER WHITE JACKET",
      productName: "RWDY WINTER WHITE JACKET",
    },
    {
      link: "/link",
      image: "SummerwinterDresses/winter7.jpg",
      alt: "RWDY WINTER LONG JACKET",
      productName: "RWDY LONG JACKET",
    },
  ];
  return (
    <div className={`d-flex  flex-column gap-3 ${styles.maincontainer}`}>
      ...
      >
        <div className={`fs-6`}>{renderLinks(BottomWearLinks)}</div>
      </div>
