...
import styles from "./Accessories.module.css"; // Import your custom CSS
...
function Caps() {
    ...
    <ul className="d-flex gap-2 list-unstyled ">
      {links.map((link, index) => (
        <li className={`nav-item `} key={index}>
          <NavLink
            className={`nav-link  ${
              link.text === "CAPS" ? styles.NavItemGray : styles.navItem
            }`}
            to={link.path}
          >
            {link.text}
  ...
  const Products = [
    {
      link: "/link",
      image: "Accessories/cap1.jpg",
      alt: "RWDY OFF DUTY CAP | BANDANA PRINT MESH",
      productName: "RWDY OFF DUTY CAP | BANDANA PRINT MESH",
      price: 3000,
    },

    {
      link: "/link",
      image: "Accessories/cap2.jpg",
      alt: "RWDY OFF DUTY CAP ORANGE",
      productName: "RWDY OFF DUTY CAP | ORANGE",
      price: 1000,
    },
    {
      link: "/link",
