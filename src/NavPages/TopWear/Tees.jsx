...
import tees2 from "../../assets/TopWear/tees2.jpg";
import tees3 from "../../assets/TopWear/tees3.jpg";
import tees4 from "../../assets/TopWear/tees4.jpg";
import tees5 from "../../assets/TopWear/tees5.jpg";
import tees6 from "../../assets/TopWear/tees6.jpg";
import tees7 from "../../assets/TopWear/tees7.jpg";
import tees8 from "../../assets/TopWear/tees8.jpg";
    ...
    <ul className="d-flex gap-2 list-unstyled flex-wrap">
      {links.map((link, index) => (
        <li className={`nav-item `} key={index}>
          <NavLink
            className={`nav-link  ${
              link.text === "TEES" ? styles.NavItemGray : styles.navItem
            }`}
            to={link.path}
          >
            {link.text}
